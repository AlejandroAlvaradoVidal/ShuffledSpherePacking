...
patience = 60;          % Iteraciones permitidas sin mejora
burn_in = 300;          % Mínimo de iteraciones antes de evaluar salida
...
plot_mode = 1; 
export_path = './graphs'; % Directorio para guardar si plot_mode = 1
sf=0; % 1 for save C
